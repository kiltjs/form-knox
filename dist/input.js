...
function initInput(input, options) {
  ...
  var component = {
    ...
    emit: function emit(event_name, args, this_arg) {
  ...
  (0, _utils._defineProperty)(component, 'value', function () {
    ...
    previous_value = '';
    input.value = value || ''; // previous_value = input.value; // needs to be triggered, p.e. add _is-not_empty class 
  ...
  if (options.bind_model !== false) {
    (0, _utils._defineProperty)(input, 'model', function () {
      return component.model;
    }, function (model) {
      component.model = model;
    });
    (0, _utils._defineProperty)(input, 'is_filled', function () {
      return mask_filled;
    });
  }
